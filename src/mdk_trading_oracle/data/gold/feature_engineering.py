"""Gold Layer Feature Engineering: Calculates rolling institutional flow and signal metrics."""
...
class GoldFeatureEngineer:
    """Computes high-alpha feature representations from Silver tables in DuckDB."""
    ...
    def compute_institutional_signals(self) -> dict[str, Any]:
        """Compute rolling 5-day and 20-day BofA flows and Z-scores from `silver_market_daily`."""
    ...
    def run_all(self) -> dict[str, Any]:
        """Run full Gold feature pipeline."""
