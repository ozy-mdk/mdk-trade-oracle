...
KNOWN_INSTRUMENTS_META: Dict[str, Dict[str, Any]] = {
    ...
    "ARCLK": {"name": "Arçelik A.Ş.", "sector": "Consumer Durables", "index": "BIST50"},
    ...
    "DSTKF": {"name": "Destek Finans Faktoring A.Ş.", "sector": "Financial Services", "index": "BIST30"},
    ...
    "GUBRF": {"name": "Gübre Fabrikaları T.A.Ş.", "sector": "Chemicals", "index": "BIST30"},
    "HALKB": {"name": "Türkiye Halk Bankası A.Ş.", "sector": "Banking", "index": "BIST50"},
    ...
    "MGROS": {"name": "Migros Ticaret A.Ş.", "sector": "Retail", "index": "BIST30"},
    ...
    "TRALT": {"name": "Darphane Altın Sertifikası (Gram Altın)", "sector": "Commodity ETF", "index": "BIST30"},
